...
class GrayScott(Campaign):
    ...
    sweep1_parameters = [
            ...
            p.ParamConfig       ('simulation', 'array_dimention', 'settings-files.json', 'L', [16, 64, 128]),
            ...
            p.ParamConfig       ('simulation', 'feed_rate_U', 'settings-files.json', 'F', [0.01, 0.04]),
            p.ParamConfig       ('simulation', 'kill_rate_V', 'settings-files.json', 'k', [0.04, 0.05]),

            p.ParamConfig       ('simulation', 'Timestep', 'settings-files.json', 'dt', [5, 10]),
            p.ParamConfig       ('simulation', 'simulation_steps', 'settings-files.json', 'steps', [100, 500, 1000]),
            p.ParamConfig       ('simulation', 'indused_noise', 'settings-files.json', 'noise', [0.000001]),
    ...
    sweepGroup1 = p.SweepGroup ("sg-1", # A unique name for the SweepGroup
                                walltime=7000000,  # Total runtime for the SweepGroup
