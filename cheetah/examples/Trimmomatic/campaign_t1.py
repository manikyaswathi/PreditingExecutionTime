...
class GrayScott(Campaign):
    ...
    sweep1_parameters = [
            ...
            p.ParamCmdLineArg   ('trimming', 'threads', 2, ["-threads 2"]),
            p.ParamCmdLineArg   ('trimming', 'input1', 3, ["/home/parallels/Documents/Trimmomatic/SRR1210633_1_subsampled.fastq"]),
            p.ParamCmdLineArg   ('trimming', 'input2', 4, ["/home/parallels/Documents/Trimmomatic/SRR1210633_2_subsampled.fastq"]),
            ...
            p.ParamCmdLineArg   ('trimming', 'LEADING', 10, ["LEADING:3"]),
            p.ParamCmdLineArg   ('trimming', 'TRAILING', 11, ["TRAILING:3"]),
            p.ParamCmdLineArg   ('trimming', 'SlidingWindow', 12, ["SLIDINGWINDOW:4:15"]),
            p.ParamCmdLineArg   ('trimming', 'MinLength', 13, ["MINLEN:36"]),
            p.ParamCmdLineArg   ('trimming', 'MaxInfo', 14, ["MAXINFO:50:0.2"]),
    ]
    """
    # Setup the sweep parameters for a Sweep
    sweep1_parameters = [
    ...
    sweepGroup1 = p.SweepGroup ("sg-1", # A unique name for the SweepGroup
                                walltime=100,  # Total runtime for the SweepGroup
                                per_run_timeout=10,    # Timeout for each experiment                                
